    ...
    static class ContentDownloader
    {
            ...
            else
            {
                ...
                if (neededChunks.Count() == 0)
                {
                    lock (depotDownloadCounter)
                    {
                        ...
                        if(DepotDownloaderLib.onConsoleOutput != null)
                            DepotDownloaderLib.onConsoleOutput.Invoke((depotDownloadCounter.SizeDownloaded / (float)depotDownloadCounter.CompleteDownloadSize) * 100.0f, fileFinalPath);
                    }
            ...
            ProtoManifest.ChunkData chunk)
        {
            ...
            if (remainingChunks == 0)
            {
                ...
                if(DepotDownloaderLib.onConsoleOutput != null)
                    DepotDownloaderLib.onConsoleOutput.Invoke((sizeDownloaded / (float)depotDownloadCounter.CompleteDownloadSize) * 100.0f, fileFinalPath);
            }
        }
